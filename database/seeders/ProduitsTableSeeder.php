...
class ProduitsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $produit->prix_ht = 175;
        $produit->description = "Une doudoune parfaite pour les plus frileux d'entre vous";
        $produit->photo_principale = "";
        $produit->save();
        ...
        $produit->prix_ht = 2;
        $produit->description = "Décidément il y en a pour tous les gouts et a ce prix la c'est cadeau";
        $produit->photo_principale = "";
        $produit->save();
    }
}
