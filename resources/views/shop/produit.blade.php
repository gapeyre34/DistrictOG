            ...
            <div class="row justify-content-between">
                ...
                <div class="col-6">
                    <div class="card mb-4 box-shadow">
                        <img class="card-img-top" src="{{asset("imgs/produits/{$produit->photo_principale}")}}" alt="Card image cap">
        ...
        <div class="album py-5 bg-light">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="card mb-4 box-shadow">
                            <img src="{{asset("imgs/produits/skate_mafia.jpg")}}" class="card-img-top img-fluid" alt="Responsive image">
                    ...
                    <div class="col-md-4">
                        <div class="card mb-4 box-shadow">
                            <img src="{{asset("imgs/produits/tnf.jpg")}}" class="card-img-top img-fluid" alt="Responsive image">
                    ...
                    <div class="col-md-4">
                        <div class="card mb-4 box-shadow">
                            <img src="{{asset("imgs/produits/air_max_97.jpg")}}" class="card-img-top img-fluid" alt="Responsive image">
